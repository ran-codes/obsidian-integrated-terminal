...
1. **Create the plugin directory if needed**:
   ```bash
   mkdir -p "D:/GitHub/work/.obsidian/plugins/integrated-terminal/node_modules"
   ```

2. **Copy plugin files** (main.js, manifest.json, styles.css, pty-host.js):
   ```bash
   cp D:/GitHub/obsidian-vs-code-terminal/main.js D:/GitHub/obsidian-vs-code-terminal/manifest.json D:/GitHub/obsidian-vs-code-terminal/styles.css D:/GitHub/obsidian-vs-code-terminal/pty-host.js "D:/GitHub/work/.obsidian/plugins/integrated-terminal/"
   ```
